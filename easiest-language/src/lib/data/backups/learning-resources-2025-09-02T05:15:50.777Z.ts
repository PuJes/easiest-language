 ...
 * 最后更新时间: 2025-09-02T05:15:12.943Z
 */
export const LEARNING_RESOURCES_BY_LANGUAGE: Record<string, LearningResource[]> = {
  'ar': [
    {
      ...
      'description': 'Comprehensive Arabic language podcast with multiple dialects and cultural insights',
      'free': false
    },
    {
  ...
  'en': [
    {
      ...
      'description': 'Comprehensive grammar reference book with clear explanations and practical exercises',
      'free': false
    },
    {
  ...
  'es': [
    ...
    },
    {
      'title': 'pjpjpj',
      'type': 'app',
      'url': 'https://mp.weixin.qq.com/s/Mg5utkp0iD_b0RGMbCvA4A',
      'description': 'pjpjpj',
      'free': true
    },
  ],
  ...
  'fr': [
    {
      ...
      'description': 'Authoritative French learning podcast with native speakers and structured lessons',
      'free': false
    },
    {
  ...
  'it': [
    {
      ...
      'description': 'Comprehensive Italian audio program with cultural context and conversation skills',
      'free': false
    },
    {
  ...
  'ja': [
    ...
    },
    {
      ...
      'type': 'book',
      'description': 'Standard university-level Japanese textbook with comprehensive grammar and kanji',
      'free': false
    },
    {
      'title': 'Anki',
  ...
  'ko': [
    {
      ...
      'description': 'Authoritative Korean language podcast with native speakers and structured lessons',
      'free': false
    },
    {
      'title': 'TTMIK',
  ...
  'ru': [
    {
      ...
      'description': 'Comprehensive Russian audio program with native speakers and structured progression',
      'free': false
    },
    {
  ...
  'zh': [
    {
      ...
      'description': 'Systematic Chinese language podcast with structured lessons and cultural context',
      'free': false
    },
    {
      'title': 'HelloChinese',
      'type': 'app',
      'description': 'Beginner-friendly Chinese learning app with simplified characters and pronunciation',
      'free': true
    },
    {
