...
export const CULTURE_DATA: Record<string, CultureInfo> = {
  ...
  es: {
    overview:
      'es is a fascinating language with unique cultural characteristics. Learning it opens doors to new perspectives and cultural experiences.',
    businessUse:
      "es can be valuable for international business, especially in regions where it's widely spoken.",
    entertainment: [
      'Local Music',
      'Traditional Arts',
      'Cultural Festivals',
